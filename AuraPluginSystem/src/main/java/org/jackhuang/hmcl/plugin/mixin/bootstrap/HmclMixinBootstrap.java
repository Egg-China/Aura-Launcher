...
public final class HmclMixinBootstrap {
    ...
    /// Launcher-version override also consumed by the regular Aura metadata path.
    private static final String LAUNCHER_VERSION_OVERRIDE_PROPERTY = "aura.version.override";
    ...
    /// Property containing the launcher version in the embedded build metadata resource.
    private static final String LAUNCHER_VERSION_PROPERTY = "aura.version";

    /// Development fallback matching the regular Aura metadata path for exploded class directories.
