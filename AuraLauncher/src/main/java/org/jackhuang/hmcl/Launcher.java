...
public final class Launcher extends Application {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LOG.info("Aura User Home: " + Metadata.AURA_USER_HOME);
            LOG.info("Aura Local Home: " + Metadata.AURA_LOCAL_HOME);
            LOG.info("Aura Jar Path: " + Lang.requireNonNullElse(JarUtils.thisJarPath(), "Not Found"));
            LOG.info("Aura Log File: " + Lang.requireNonNullElse(LOG.getLogFile(), "In Memory"));
