                ...
                [
                  {
                    ...
                    "prerelease": true,
                    "assets": [{"name":"Aura-Launcher-26.8-beta.3.jar","browser_download_url":"https://example.invalid/beta.jar","digest":"%s"}]
                  },
                  {
                    "tag_name": "v26.8-release.2",
                    "prerelease": false,
                    "assets": [{"name":"Aura-Launcher-26.8-release.2.jar","browser_download_url":"https://example.invalid/release.jar","digest":"%s"}]
                  }
                ]
                ...
                [
                  {
                    ...
                    "prerelease": true,
                    "assets": [{"name":"Aura-Launcher-26.9-beta.1.jar","browser_download_url":"https://example.invalid/dev.jar","digest":"%s"}]
                  },
                  {
                    "tag_name": "v26.8-release.2",
                    "prerelease": false,
                    "assets": [{"name":"Aura-Launcher-26.8-release.2.jar","browser_download_url":"https://example.invalid/stable.jar","digest":"%s"}]
                  }
                ]
                """.formatted(digest, digest);
                ...
                [
                  {
                    ...
                    "prerelease": true,
                    "assets": [{"name":"Aura-Launcher-26.8-beta.4.jar","browser_download_url":"https://example.invalid/preview.jar","digest":"%s"}]
                  },
                  {
                    "tag_name": "v26.8-release.2",
                    "prerelease": false,
    ...
    public void rejectsMissingExactAssetOrDigest() {
        String missingExactAsset = """
                [{
                  "tag_name":"v26.8-release.2",
                  "prerelease":false,
                  "assets":[{"name":"Aura-Launcher-26.8-release.2-extra.jar","browser_download_url":"https://example.invalid/wrong.jar","digest":"sha256:%s"}]
                }]
        ...
        String missingDigest = """
                [{
                  "tag_name":"v26.8-release.2",
                  "prerelease":false,
                  "assets":[{"name":"Aura-Launcher-26.8-release.2.jar","browser_download_url":"https://example.invalid/release.jar"}]
                }]
                """;
