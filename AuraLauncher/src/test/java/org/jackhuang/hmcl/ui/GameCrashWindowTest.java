...
/// Provides a manual JavaFX smoke test for rendering a representative game crash report.
@NotNullByDefault
public class GameCrashWindowTest {

    /// Opens the crash window with a fixture log when explicitly enabled for manual testing.
    @Test
    @Disabled
    public void test() throws Exception {
        ...
        String logs = Files.readString(new File("../AuraCore/src/test/resources/logs/too_old_java.txt").toPath());
